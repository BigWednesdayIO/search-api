...
const ModifyEncodedQuery = require('./encoded_query_modifier');

const plugins = [
  {register: Version},
  {register: AnalyticsLogger},
  {register: ModifyEncodedQuery},
  {
    register: Swaggerize,
    options: {
...
module.exports = callback => {
  ...
  server.decorate('reply', 'maximumRecordsReached', function () {
    this.response(Boom.forbidden('Maximum number of records reached'));
  });
