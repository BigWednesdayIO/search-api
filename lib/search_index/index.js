  ...
  saveSettings(settings) {
    return createIndexIfNotExists(this._indexName)
      ...
      .then(currentMapping => {
        ...
        settings.searchable_fields.forEach(field => {
        ...
        // disable previously searchable fields
        const oldFieldsToDisable = _.difference(Object.keys(currentMappingProperties), settings.searchable_fields);
        oldFieldsToDisable.forEach(field => {
          mapping[objectTypeInIndex].properties[field].index = 'no';
        });
